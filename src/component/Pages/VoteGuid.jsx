    ...
    <>
      ...
      <div className="container demo">
        ...
        <p className=" text-light">
          ...
          Madhya Pradesh Election 2023, the useful platform of mpvoter.com gives
          you the power to make your opinion and your voice heard across all of
          social media. The process is simplified so that every MP Voter can
          express their choice and views in a matter of minutes.
        </p>
        <p className=" text-light">
          Keeping in view the Assembly Election 2023, the platform has
