...
const Drop = () => {
  ...
  const client = location?.state?.useremail;
  ...
  //   debugger
  //   try {
  //     const url = "https://backlaravel.mpvoter.com/api/verify_login";
  ...
  return (
    <div className="container poll-form-1">
      ...
      {toggle === false ? (
        <div className="container poll-form vote">
